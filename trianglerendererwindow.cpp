...
TriangleRendererWindow::TriangleRendererWindow(QScreen *outputScreen,
                                               OpenGLRendererAbstract::OpenGLRenderSpecs specs,
                                               const QSurfaceFormat &surfaceFormat,
                                               QOpenGLContext *sharedContext) :
    QTOpenGLRenderWindow(outputScreen,
                         specs,
                         surfaceFormat,
                         sharedContext),
    depthrenderbuffer(0),
...
void TriangleRendererWindow::setFrameRate(float fps)
{
    QTOpenGLRenderer::setFrameRate(fps);
}

void TriangleRendererWindow::start()
{
    float timeOut = 1000.0f/renderSpecs.frameRate;
    syncTimer->start(timeOut);
}

void TriangleRendererWindow::stop()
{
    syncTimer->stop();
}

void TriangleRendererWindow::renderFrame()
{
    updateStartTime();
...
void TriangleRendererWindow::initializeFBO()
{
...
void TriangleRendererWindow::initializeShaderProgram()
{
...
void TriangleRendererWindow::initializeVertexBuffers()
{
...
void TriangleRendererWindow::initializeUniforms()
{

}

void TriangleRendererWindow::updateUniforms()
{
    shader->bind();
...
void TriangleRendererWindow::initializeTimer()
{
    syncTimer = new QTimer(this);
    syncTimer->setTimerType(Qt::PreciseTimer);

    QObject::connect(syncTimer,&QTimer::timeout,this,&TriangleRendererWindow::renderFrame);
}
